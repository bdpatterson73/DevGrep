...
using IndexFileNameFilter = SmartSearch.Index.IndexFileNameFilter;
using IndexWriter = SmartSearch.Index.IndexWriter;
...
namespace SmartSearch.Store
{
	...
	public abstract class FSDirectory : Directory
	{
		...
		/// This method should be used in <see cref="SmartSearch.Store.Directory.CreateOutput(string)" />. 
		/// </summary>
		...
		protected internal FSDirectory(System.IO.DirectoryInfo path, LockFactory lockFactory)
		{
            ...
            // system property SmartSearch.Store.FSDirectoryLockFactoryClass is set,
		...
		public static FSDirectory Open(System.IO.DirectoryInfo path, LockFactory lockFactory)
		{
			...
			*/
			...
			{
                //NIOFSDirectory is not implemented in SmartSearch
        ...
        // For SmartSearch, GetDirectory() is more appropriate
