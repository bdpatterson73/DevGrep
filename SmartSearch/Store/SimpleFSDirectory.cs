			...
			public override void  ReadInternal(byte[] b, int offset, int len)
			{
				lock (file)
				{
					...
					catch (System.OutOfMemoryException e)
					{
						...
						System.OutOfMemoryException outOfMemoryError = new System.OutOfMemoryException("OutOfMemoryError likely caused by the Sun VM Bug described in " + "-" + "with a a value smaller than the current chunks size (" + chunkSize + ")", e);
