...
namespace SmartSearch.Analysis
{
    ...
    /// in a future release (possible SmartSearch 4.0)
	/// </deprecated>
    [Obsolete("If you build a new index, use ASCIIFoldingFilter which covers a superset of Latin 1.  This class is included for use with existing indexes and will be removed in a future release (possible SmartSearch 4.0).")]
