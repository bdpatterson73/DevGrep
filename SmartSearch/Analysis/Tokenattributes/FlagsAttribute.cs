...
namespace SmartSearch.Analysis.Tokenattributes
{
	...
	public class FlagsAttribute:Util.Attribute, IFlagsAttribute, System.ICloneable
	{
	    ...
	    /// The flags can be used to encode information about the token for use by other <see cref="SmartSearch.Analysis.TokenFilter" />s.
	    /// 
	    /// 
	    /// </summary>
