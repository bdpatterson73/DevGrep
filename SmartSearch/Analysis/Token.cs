...
namespace SmartSearch.Analysis
{
	...
	/// that are part of core SmartSearch and can be found in the <see cref="SmartSearch.Analysis.Tokenattributes"/> namespace.
	...
	/// <list type="bullet">
    /// <item>clear() initializes all of the fields to default values. This was changed in contrast to SmartSearch, but should affect no one.</item>
	...
	/// <p/>
	/// </summary>
	/// <seealso cref="SmartSearch.Index.Payload">
	/// </seealso>
	[Serializable]
	public class Token : Attribute, ITermAttribute, ITypeAttribute, IPositionIncrementAttribute, IFlagsAttribute, IOffsetAttribute, IPayloadAttribute
	{
	    ...
	    /// <seealso cref="SmartSearch.Index.TermPositions">
	    /// </seealso>
