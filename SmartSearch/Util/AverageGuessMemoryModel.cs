...
namespace SmartSearch.Util
{
	...
	public class AverageGuessMemoryModel:MemoryModel
	{
		...
		* (non-Javadoc)
		* 
		* <see cref="SmartSearch.Util.MemoryModel.getArraySize()"/>
		*/
		...
		* (non-Javadoc)
		* 
		* <see cref="SmartSearch.Util.MemoryModel.getClassSize()"/>
		*/
	    ...
	    /* (non-Javadoc)
		* <see cref="SmartSearch.Util.MemoryModel.getPrimitiveSize(java.lang.Class)"/>
		*/
		...
		/* (non-Javadoc)
		* <see cref="SmartSearch.Util.MemoryModel.getReferenceSize()"/>
		*/
