...
using FieldInvertState = SmartSearch.Index.FieldInvertState;
using Term = SmartSearch.Index.Term;
using SmallFloat = SmartSearch.Util.SmallFloat;
using IDFExplanation = SmartSearch.Search.Explanation.IDFExplanation;
...
namespace SmartSearch.Search
{
    ...
    /// <see cref="SmartSearch.Search.DefaultSimilarity.Tf(float)">DefaultSimilarity</see> is:
	/// 
	/// <br/>&#160;<br/>
	/// <table cellpadding="2" cellspacing="2" border="0" align="center">
	/// <tr>
	/// <td valign="middle" align="right" rowspan="1">
    /// <see cref="SmartSearch.Search.DefaultSimilarity.Tf(float)">tf(t in d)</see> &#160; = &#160;
	/// </td>
    ...
    /// <see cref="SmartSearch.Search.DefaultSimilarity.Idf(int, int)">DefaultSimilarity</see> is:
	/// 
	/// <br/>&#160;<br/>
	/// <table cellpadding="2" cellspacing="2" border="0" align="center">
	/// <tr>
	/// <td valign="middle" align="right">
    /// <see cref="SmartSearch.Search.DefaultSimilarity.Idf(int, int)">idf(t)</see>&#160; = &#160;
	/// </td>
    ...
    /// <see cref="SmartSearch.Search.DefaultSimilarity.QueryNorm(float)">DefaultSimilarity</see>
	/// is:
	/// <br/>&#160;<br/>
	/// <table cellpadding="1" cellspacing="0" border="0" align="center">
	/// <tr>
	/// <td valign="middle" align="right" rowspan="1">
	/// queryNorm(q)  &#160; = &#160;
    /// <see cref="SmartSearch.Search.DefaultSimilarity.QueryNorm(float)">queryNorm(sumOfSquaredWeights)</see>
	/// &#160; = &#160;
	/// </td>
	...
	/// computed by the query <see cref="SmartSearch.Search.Weight" /> object.
	/// For example, a <see cref="SmartSearch.Search.BooleanQuery">boolean query</see>
	...
	/// <tr>
	/// <td valign="middle" align="right" rowspan="1">
    /// <see cref="SmartSearch.Search.Weight.GetSumOfSquaredWeights">GetSumOfSquaredWeights</see> &#160; = &#160;
    /// <see cref="SmartSearch.Search.Query.Boost">q.Boost</see> <sup><big>2</big></sup>
	/// &#160;&#183;&#160;
	/// </td>
	/// <td valign="bottom" align="center" rowspan="1">
	/// <big><big><big>&#8721;</big></big></big>
	...
	/// <see cref="SmartSearch.Search.Query.Boost" />.
	/// Notice that there is really no direct API for accessing a boost of one term in a multi term query,
	/// but rather multi terms are represented in a query as multi
	/// <see cref="SmartSearch.Search.TermQuery">TermQuery</see> objects,
    ...
    /// <see cref="SmartSearch.Documents.Document.Boost">doc.Boost</see>
	...
	/// <see cref="SmartSearch.Store.Directory">directory</see> and
	...
	/// </seealso>
	/// <seealso cref="SmartSearch.Index.IndexWriter.Similarity">
	/// </seealso>
	...
	public abstract class Similarity
	{
	    ...
	    /// <seealso cref="Searcher.Similarity">
	    /// </seealso>
	    /// <seealso cref="SmartSearch.Index.IndexWriter.SetSimilarity(Similarity)">
	    /// </seealso>
		...
		/// <see cref="SmartSearch.Index.IndexWriter.AddDocument(SmartSearch.Documents.Document)" /> 
		...
		/// 
		/// </returns>
		/// <seealso cref="SmartSearch.Documents.AbstractField.Boost" />
		...
		/// </summary>
		/// <seealso cref="SmartSearch.Documents.AbstractField.Boost" />
		/// <seealso cref="SmartSearch.Util.SmallFloat" />
		...
		/// <see cref="SmartSearch.Index.IndexReader.NumDocs()" /> because it is
