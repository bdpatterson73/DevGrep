...
namespace SmartSearch.Search
{
    ...
    /// <item> <see cref="SmartSearch.Search.Spans.SpanQuery" /> </item>
	/// </list>
	/// <p/>A parser for queries is contained in:
	/// <list type="bullet">
    /// <item><see cref="SmartSearch.QueryParsers.QueryParser">QueryParser</see> </item>
	/// </list>
	/// </summary>
	[Serializable]
	public abstract class Query : System.ICloneable
	{
		...
		/// by <see cref="SmartSearch.QueryParsers.QueryParser">QueryParser</see>. However,
