		...
		private sealed class TimerThread:ThreadClass
		{
			...
			override public void  Run()
			{
				while (true)
				{
					...
					time += SmartSearch.Search.TimeLimitingCollector.resolution;
					System.Threading.Thread.Sleep(new System.TimeSpan((System.Int64) 10000 * SmartSearch.Search.TimeLimitingCollector.resolution));
