...
namespace SmartSearch.Search.Function
{
	...
	/// values obtained from a <see cref="SmartSearch.Search.Function.ValueSource">ValueSource</see>.
	/// <p/>
	...
	public class ValueSourceQuery:Query
	{
		...
		internal class ValueSourceWeight:Weight
		{
			...
			/*(non-Javadoc) <see cref="SmartSearch.Search.Weight.explain(SmartSearch.Index.IndexReader, int) */
        ...
        private class ValueSourceScorer : Scorer
        {
            ...
            /*(non-Javadoc) <see cref="SmartSearch.Search.Scorer.explain(int) */
