...
namespace SmartSearch.Search.Function
{
	...
	/// a single field from the <see cref="SmartSearch.Search.FieldCache">FieldCache</see>.
	/// <p/>
	...
	public abstract class FieldCacheSource:ValueSource
	{
		...
		{
			return GetCachedFieldValues(SmartSearch.Search.FieldCache_Fields.DEFAULT, field, reader);
		}
