...
using ComplexExplanation = SmartSearch.Search.ComplexExplanation;
...
namespace SmartSearch.Search.Function
{
	...
	/// <see cref="SmartSearch.Search.Function.FieldScoreQuery">FieldScoreQuery</see></item>
	/// </list>
	...
	public class CustomScoreQuery:Query, System.ICloneable
	{
		...
		/// <see cref="SmartSearch.Search.Function.FieldScoreQuery">FieldScoreQuery</see>.
		...
		/// <see cref="SmartSearch.Search.Function.FieldScoreQuery">FieldScoreQueries</see>.
		/// This parameter is optional - it can be null or even an empty array.
		/// </param>
		...
		/*(non-Javadoc) <see cref="SmartSearch.Search.Query.rewrite(SmartSearch.Index.IndexReader) */
		...
		/*(non-Javadoc) <see cref="SmartSearch.Search.Query.extractTerms(java.util.Set) */
		...
		/*(non-Javadoc) <see cref="SmartSearch.Search.Query.clone() */
		...
		/* (non-Javadoc) <see cref="SmartSearch.Search.Query.toString(java.lang.String) */
        ...
        /// </summary>
        [Obsolete("Will be removed in SmartSearch 3.1")]
		...
		private class CustomWeight:Weight
		{
			...
			/*(non-Javadoc) <see cref="SmartSearch.Search.Weight.getQuery() */
		    ...
		    /*(non-Javadoc) <see cref="SmartSearch.Search.Weight.getValue() */
		    ...
		    /*(non-Javadoc) <see cref="SmartSearch.Search.Weight.sumOfSquaredWeights() */
		    ...
		    /*(non-Javadoc) <see cref="SmartSearch.Search.Weight.normalize(float) */
		...
		private class CustomScorer:Scorer
		{
			...
			/*(non-Javadoc) <see cref="SmartSearch.Search.Scorer.score() */
