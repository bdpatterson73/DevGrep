...
namespace SmartSearch.Search.Function
{
	...
	/// <see cref="SmartSearch.Search.FieldCache">FieldCache</see> using getStringIndex()
	...
	public class ReverseOrdFieldSource:ValueSource
	{
		private class AnonymousClassDocValues:DocValues
		{
			...
			/* (non-Javadoc) <see cref="SmartSearch.Search.Function.DocValues.strVal(int) */
		...
		/*(non-Javadoc) <see cref="SmartSearch.Search.Function.ValueSource.getValues(SmartSearch.Index.IndexReader) */
		public override DocValues GetValues(IndexReader reader)
		{
			SmartSearch.Search.StringIndex sindex = SmartSearch.Search.FieldCache_Fields.DEFAULT.GetStringIndex(reader, field);
