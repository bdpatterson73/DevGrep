...
using FieldCache = SmartSearch.Search.FieldCache;

namespace SmartSearch.Search.Function
{
	
	/// <summary> Expert: obtains short field values from the 
	/// <see cref="SmartSearch.Search.FieldCache">FieldCache</see>
	...
	/// 
	/// </summary>
	/// <seealso cref="SmartSearch.Search.Function.FieldCacheSource"> for requirements
	/// on the field.
	/// 
	...
	public class ShortFieldSource:FieldCacheSource
	{
		private class AnonymousClassDocValues:DocValues
		{
			...
			/*(non-Javadoc) <see cref="SmartSearch.Search.Function.DocValues.floatVal(int) */
			public override float FloatVal(int doc)
			{
				return (float) arr[doc];
			}
			/*(non-Javadoc) <see cref="SmartSearch.Search.Function.DocValues.intVal(int) */
			public override int IntVal(int doc)
			{
				return arr[doc];
			}
			/*(non-Javadoc) <see cref="SmartSearch.Search.Function.DocValues.toString(int) */
			public override System.String ToString(int doc)
			{
				return Enclosing_Instance.Description() + '=' + IntVal(doc);
			}
			/*(non-Javadoc) <see cref="SmartSearch.Search.Function.DocValues.getInnerArray() */
		...
		private SmartSearch.Search.ShortParser parser;
		...
		public ShortFieldSource(System.String field, SmartSearch.Search.ShortParser parser):base(field)
		{
			this.parser = parser;
		}
		
		/*(non-Javadoc) <see cref="SmartSearch.Search.Function.ValueSource.description() */
		public override System.String Description()
		{
			return "short(" + base.Description() + ')';
		}
		
		/*(non-Javadoc) <see cref="SmartSearch.Search.Function.FieldCacheSource.getCachedValues(SmartSearch.Search.FieldCache, java.lang.String, SmartSearch.Index.IndexReader) */
		...
		/*(non-Javadoc) <see cref="SmartSearch.Search.Function.FieldCacheSource.cachedFieldSourceEquals(SmartSearch.Search.Function.FieldCacheSource) */
		...
		/*(non-Javadoc) <see cref="SmartSearch.Search.Function.FieldCacheSource.cachedFieldSourceHashCode() */
