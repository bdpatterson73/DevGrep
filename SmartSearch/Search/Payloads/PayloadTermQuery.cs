...
using TermPositions = SmartSearch.Index.TermPositions;
...
using SpanTermQuery = SmartSearch.Search.Spans.SpanTermQuery;
using SpanWeight = SmartSearch.Search.Spans.SpanWeight;
using TermSpans = SmartSearch.Search.Spans.TermSpans;

namespace SmartSearch.Search.Payloads
{
	
	/// <summary> This class is very similar to
	/// <see cref="SmartSearch.Search.Spans.SpanTermQuery" /> except that it factors
	/// in the value of the payload located at each of the positions where the
	/// <see cref="SmartSearch.Index.Term" /> occurs.
	/// <p/>
	/// In order to take advantage of this, you must override
    /// <see cref="SmartSearch.Search.Similarity.ScorePayload(int, String, int, int, byte[],int,int)" />
