...
using BooleanClause = SmartSearch.Search.BooleanClause;
using BooleanQuery = SmartSearch.Search.BooleanQuery;
using DisjunctionMaxQuery = SmartSearch.Search.DisjunctionMaxQuery;
using FilteredQuery = SmartSearch.Search.FilteredQuery;
using MultiPhraseQuery = SmartSearch.Search.MultiPhraseQuery;
using PhraseQuery = SmartSearch.Search.PhraseQuery;
using Query = SmartSearch.Search.Query;
using TermQuery = SmartSearch.Search.TermQuery;
using SpanNearQuery = SmartSearch.Search.Spans.SpanNearQuery;
using SpanOrQuery = SmartSearch.Search.Spans.SpanOrQuery;
