...
using QueryParser = SmartSearch.QueryParsers.QueryParser;
...
namespace SmartSearch.Search
{
	...
	public abstract class MultiTermQuery:Query
	{
		...
		public class AnonymousClassConstantScoreAutoRewrite:ConstantScoreAutoRewrite
		{
			...
			{
				return SmartSearch.Search.MultiTermQuery.CONSTANT_SCORE_AUTO_REWRITE_DEFAULT;
			}
		}
		...
		private sealed class ConstantScoreFilterRewrite:RewriteMethod
		{
			...
			{
				return SmartSearch.Search.MultiTermQuery.CONSTANT_SCORE_FILTER_REWRITE;
			}
		}
		...
		private class ScoringBooleanQueryRewrite:RewriteMethod
		{
			...
			protected internal virtual System.Object ReadResolve()
			{
				return SmartSearch.Search.MultiTermQuery.SCORING_BOOLEAN_QUERY_REWRITE;
			}
		}
		...
		private class ConstantScoreBooleanQueryRewrite:ScoringBooleanQueryRewrite
		{
			...
			{
				return SmartSearch.Search.MultiTermQuery.CONSTANT_SCORE_BOOLEAN_QUERY_REWRITE;
			}
		}
