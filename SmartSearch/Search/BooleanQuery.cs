...
using Occur = SmartSearch.Search.Occur;
...
namespace SmartSearch.Search
{
	...
	public class BooleanQuery : Query, System.Collections.Generic.IEnumerable<BooleanClause>, System.ICloneable
	{
		...
		private class AnonymousClassSimilarityDelegator:SimilarityDelegator
		{
			...
			internal AnonymousClassSimilarityDelegator(BooleanQuery enclosingInstance, SmartSearch.Search.Similarity Param1):base(Param1)
			{
		...
		public class TooManyClauses:System.SystemException
		{
			public override System.String Message
			{
				get
				{
					return "maxClauseCount is set to " + SmartSearch.Search.BooleanQuery._maxClauses;
				}
