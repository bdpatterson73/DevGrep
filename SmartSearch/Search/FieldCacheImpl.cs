...
using Term = SmartSearch.Index.Term;
using TermDocs = SmartSearch.Index.TermDocs;
using TermEnum = SmartSearch.Index.TermEnum;
using FieldCacheSanityChecker = SmartSearch.Util.FieldCacheSanityChecker;
using Single = SmartSearch.Support.Single;
using StringHelper = SmartSearch.Util.StringHelper;
...
namespace SmartSearch.Search
{
    ...
    class FieldCacheImpl : FieldCache
    {
        ...
        // SmartSearch: java version 3.0.3 with patch in rev. 912330 applied:
        ...
        internal sealed class ByteCache:Cache
        {
            ...
            protected internal override System.Object CreateValue(IndexReader reader, Entry entryKey)
            {
                ...
                if (parser == null)
                {
                    return wrapper.GetBytes(reader, field, SmartSearch.Search.FieldCache_Fields.DEFAULT_BYTE_PARSER);
                }
        ...
        internal sealed class ShortCache:Cache
        {
            ...
            protected internal override System.Object CreateValue(IndexReader reader, Entry entryKey)
            {
                ...
                if (parser == null)
                {
                    return wrapper.GetShorts(reader, field, SmartSearch.Search.FieldCache_Fields.DEFAULT_SHORT_PARSER);
                }
        ...
        internal sealed class IntCache:Cache
        {
            ...
            protected internal override System.Object CreateValue(IndexReader reader, Entry entryKey)
            {
                ...
                if (parser == null)
                {
                    try
                    {
                        return wrapper.GetInts(reader, field, SmartSearch.Search.FieldCache_Fields.DEFAULT_INT_PARSER);
                    }
                    catch (System.FormatException)
                    {
                        return wrapper.GetInts(reader, field, SmartSearch.Search.FieldCache_Fields.NUMERIC_UTILS_INT_PARSER);
                    }
                }
                int[] retArray = null;
                TermDocs termDocs = reader.TermDocs();
        ...
        internal sealed class FloatCache:Cache
        {
            ...
            protected internal override System.Object CreateValue(IndexReader reader, Entry entryKey)
            {
                ...
                if (parser == null)
                {
                    try
                    {
                        return wrapper.GetFloats(reader, field, SmartSearch.Search.FieldCache_Fields.DEFAULT_FLOAT_PARSER);
                    }
                    catch (System.FormatException)
                    {
                        return wrapper.GetFloats(reader, field, SmartSearch.Search.FieldCache_Fields.NUMERIC_UTILS_FLOAT_PARSER);
                    }
                }
                float[] retArray = null;
                TermDocs termDocs = reader.TermDocs();
        ...
        // inherit javadocs
        public virtual long[] GetLongs(IndexReader reader, System.String field, SmartSearch.Search.LongParser parser)
        {
        ...
        internal sealed class LongCache:Cache
        {
            ...
            protected internal override System.Object CreateValue(IndexReader reader, Entry entryKey)
            {
                Entry entry = entryKey;
                System.String field = entry.field;
                SmartSearch.Search.LongParser parser = (SmartSearch.Search.LongParser) entry.custom;
                if (parser == null)
                {
                    try
                    {
                        return wrapper.GetLongs(reader, field, SmartSearch.Search.FieldCache_Fields.DEFAULT_LONG_PARSER);
                    }
                    catch (System.FormatException)
                    {
                        return wrapper.GetLongs(reader, field, SmartSearch.Search.FieldCache_Fields.NUMERIC_UTILS_LONG_PARSER);
                    }
                }
                long[] retArray = null;
                TermDocs termDocs = reader.TermDocs();
        ...
        // inherit javadocs
        public virtual double[] GetDoubles(IndexReader reader, System.String field, SmartSearch.Search.DoubleParser parser)
        {
        ...
        internal sealed class DoubleCache:Cache
        {
            ...
            protected internal override System.Object CreateValue(IndexReader reader, Entry entryKey)
            {
                Entry entry = entryKey;
                System.String field = entry.field;
                SmartSearch.Search.DoubleParser parser = (SmartSearch.Search.DoubleParser) entry.custom;
                if (parser == null)
                {
                    try
                    {
                        return wrapper.GetDoubles(reader, field, SmartSearch.Search.FieldCache_Fields.DEFAULT_DOUBLE_PARSER);
                    }
                    catch (System.FormatException)
                    {
                        return wrapper.GetDoubles(reader, field, SmartSearch.Search.FieldCache_Fields.NUMERIC_UTILS_DOUBLE_PARSER);
                    }
                }
