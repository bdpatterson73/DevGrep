...
namespace SmartSearch.Search
{
	...
	public class FilteredQuery:Query
	{
		...
		{
			public AnonymousClassWeight(SmartSearch.Search.Weight weight, SmartSearch.Search.Similarity similarity, FilteredQuery enclosingInstance)
			{
				InitBlock(weight, similarity, enclosingInstance);
			}
			private class AnonymousClassScorer:Scorer
			{
				private void  InitBlock(SmartSearch.Search.Scorer scorer, SmartSearch.Search.DocIdSetIterator docIdSetIterator, AnonymousClassWeight enclosingInstance)
				{
					this.scorer = scorer;
					this.docIdSetIterator = docIdSetIterator;
					this.enclosingInstance = enclosingInstance;
				}
				private SmartSearch.Search.Scorer scorer;
				private SmartSearch.Search.DocIdSetIterator docIdSetIterator;
				...
				internal AnonymousClassScorer(SmartSearch.Search.Scorer scorer, SmartSearch.Search.DocIdSetIterator docIdSetIterator, AnonymousClassWeight enclosingInstance, SmartSearch.Search.Similarity Param1):base(Param1)
				{
			...
			private void  InitBlock(SmartSearch.Search.Weight weight, SmartSearch.Search.Similarity similarity, FilteredQuery enclosingInstance)
			{
				this.weight = weight;
				this.similarity = similarity;
				this.enclosingInstance = enclosingInstance;
			}
			private SmartSearch.Search.Weight weight;
			private SmartSearch.Search.Similarity similarity;
