...
using CorruptIndexException = SmartSearch.Index.CorruptIndexException;
...
namespace SmartSearch.Search
{
	...
	public interface Searchable : IDisposable
	{
		...
		/// </summary>
		/// <seealso cref="SmartSearch.Index.IndexReader.DocFreq(Term)">
		/// </seealso>
	    ...
	    /// Called by search code to compute term weights.
	    /// </summary>
	    /// <seealso cref="SmartSearch.Index.IndexReader.MaxDoc">
	    /// </seealso>
	    int MaxDoc { get; }
		...
		/// <seealso cref="SmartSearch.Index.IndexReader.Document(int)" />
		/// <throws>  CorruptIndexException if the index is corrupt </throws>
		/// <throws>  IOException if there is a low-level IO error </throws>
		Document Doc(int i);

        /// <summary> Get the <see cref="SmartSearch.Documents.Document" />at the <c>n</c><sup>th</sup> position. The <see cref="SmartSearch.Documents.FieldSelector"/>
		/// may be used to determine what <see cref="SmartSearch.Documents.Field" />s to load and how they should be loaded.
		/// 
		/// <b>NOTE:</b> If the underlying Reader (more specifically, the underlying <c>FieldsReader</c>) is closed before the lazy <see cref="SmartSearch.Documents.Field" /> is
		/// loaded an exception may be thrown.  If you want the value of a lazy <see cref="SmartSearch.Documents.Field" /> to be available after closing you must
		...
		/// </param>
		/// <param name="fieldSelector">The <see cref="SmartSearch.Documents.FieldSelector" /> to use to determine what Fields should be loaded on the Document.  May be null, in which case all Fields will be loaded.
		/// </param>
		/// <returns> The stored fields of the <see cref="SmartSearch.Documents.Document" /> at the nth position
		/// </returns>
		/// <throws>  CorruptIndexException if the index is corrupt </throws>
		/// <throws>  IOException if there is a low-level IO error </throws>
		/// <summary> 
		/// </summary>
		/// <seealso cref="SmartSearch.Index.IndexReader.Document(int, FieldSelector)">
		/// </seealso>
