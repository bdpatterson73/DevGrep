...
using Double = SmartSearch.Support.Double;
using NumericTokenStream = SmartSearch.Analysis.NumericTokenStream;
...
using RamUsageEstimator = SmartSearch.Util.RamUsageEstimator;
...
namespace SmartSearch.Search
{
    ...
    /// </version>
    /// <seealso cref="SmartSearch.Util.FieldCacheSanityChecker">
    /// </seealso>
    ...
    class AnonymousClassByteParser : ByteParser
    {
        ...
        {
            return SmartSearch.Search.FieldCache_Fields.DEFAULT_BYTE_PARSER;
        }
        public override System.String ToString()
        {
    ...
    class AnonymousClassShortParser : ShortParser
    {
        ...
        protected internal virtual System.Object ReadResolve()
        {
            return SmartSearch.Search.FieldCache_Fields.DEFAULT_SHORT_PARSER;
        }
        public override System.String ToString()
        {
    ...
    class AnonymousClassIntParser : IntParser
    {
        ...
        protected internal virtual System.Object ReadResolve()
        {
            return SmartSearch.Search.FieldCache_Fields.DEFAULT_INT_PARSER;
        }
        public override System.String ToString()
        {
    ...
    class AnonymousClassFloatParser : FloatParser
    {
        ...
        protected internal virtual System.Object ReadResolve()
        {
            return SmartSearch.Search.FieldCache_Fields.DEFAULT_FLOAT_PARSER;
        }
        public override System.String ToString()
        {
    ...
    class AnonymousClassLongParser : LongParser
    {
        ...
        protected internal virtual System.Object ReadResolve()
        {
            return SmartSearch.Search.FieldCache_Fields.DEFAULT_LONG_PARSER;
        }
        public override System.String ToString()
        {
    ...
    class AnonymousClassDoubleParser : DoubleParser
    {
        ...
        protected internal virtual System.Object ReadResolve()
        {
            return SmartSearch.Search.FieldCache_Fields.DEFAULT_DOUBLE_PARSER;
        }
        public override System.String ToString()
        {
    ...
    class AnonymousClassIntParser1 : IntParser
    {
        ...
        protected internal virtual System.Object ReadResolve()
        {
            return SmartSearch.Search.FieldCache_Fields.NUMERIC_UTILS_INT_PARSER;
        }
        public override System.String ToString()
        {
    ...
    class AnonymousClassFloatParser1 : FloatParser
    {
        ...
        protected internal virtual System.Object ReadResolve()
        {
            return SmartSearch.Search.FieldCache_Fields.NUMERIC_UTILS_FLOAT_PARSER;
        }
        public override System.String ToString()
        {
    ...
    class AnonymousClassLongParser1 : LongParser
    {
        ...
        protected internal virtual System.Object ReadResolve()
        {
            return SmartSearch.Search.FieldCache_Fields.NUMERIC_UTILS_LONG_PARSER;
        }
        public override System.String ToString()
        {
    ...
    class AnonymousClassDoubleParser1 : DoubleParser
    {
        ...
        protected internal virtual System.Object ReadResolve()
        {
            return SmartSearch.Search.FieldCache_Fields.NUMERIC_UTILS_DOUBLE_PARSER;
        }
        public override System.String ToString()
        {
    ...
    public interface FieldCache
    {
        ...
        /// <see cref="SmartSearch.Util.FieldCacheSanityChecker" />.
        /// </para>
        /// </summary>
