...
namespace SmartSearch.Search
{
	...
	/// <c>Searcher</c> (<see cref="SmartSearch.Search.Query.CreateWeight(Searcher)" />).</item>
	...
	public abstract class Weight
	{
		...
		/// </summary>
		/// <param name="reader">
        /// the <see cref="IndexReader" /> for which to return the <see cref="SmartSearch.Search.Scorer" />.
		/// </param>
        ...
        /// if true, <see cref="SmartSearch.Search.Scorer.Score(SmartSearch.Search.Collector)" /> will be called; if false,
	    ...
	    /// <see cref="Scorer(SmartSearch.Index.IndexReader, bool, bool)" /> to
