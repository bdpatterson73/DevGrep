...
namespace SmartSearch.Search
{
	...
	public class QueryWrapperFilter:Filter
	{
		...
		{
			public AnonymousClassDocIdSet(SmartSearch.Search.Weight weight, SmartSearch.Index.IndexReader reader, QueryWrapperFilter enclosingInstance)
			{
				InitBlock(weight, reader, enclosingInstance);
			}
			private void  InitBlock(SmartSearch.Search.Weight weight, SmartSearch.Index.IndexReader reader, QueryWrapperFilter enclosingInstance)
			{
				this.weight = weight;
				this.reader = reader;
			...
			private SmartSearch.Index.IndexReader reader;
