...
{
	/// <summary> A base class for all collectors that return a <see cref="SmartSearch.Search.TopDocs" /> output. This
	...
	public abstract class TopDocsCollector<T> : Collector where T : ScoreDoc
	{
        ...
        /// <summary> Returns a <see cref="SmartSearch.Search.TopDocs" /> instance containing the given results. If
        ...
        /// with the returned <see cref="SmartSearch.Search.TopDocs" /> object, which will contain all the
        ...
        /// returned <see cref="SmartSearch.Search.TopDocs" /> object, which will contain all the results this
