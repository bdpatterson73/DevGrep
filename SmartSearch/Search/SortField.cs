...
namespace SmartSearch.Search
{
	...
	public class SortField
	{
		...
		private SmartSearch.Search.Parser parser;
		...
		/// </summary>
		public SortField(System.String field, SmartSearch.Search.Parser parser):this(field, parser, false)
		{
		}
		...
		/// <summary>  subclass an existing numeric parser, or field is null
		/// </summary>
		public SortField(System.String field, SmartSearch.Search.Parser parser, bool reverse)
		{
			if (parser is SmartSearch.Search.IntParser)
				InitFieldType(field, INT);
			else if (parser is SmartSearch.Search.FloatParser)
				InitFieldType(field, FLOAT);
			else if (parser is SmartSearch.Search.ShortParser)
				InitFieldType(field, SHORT);
			else if (parser is SmartSearch.Search.ByteParser)
				InitFieldType(field, BYTE);
			else if (parser is SmartSearch.Search.LongParser)
				InitFieldType(field, LONG);
			else if (parser is SmartSearch.Search.DoubleParser)
