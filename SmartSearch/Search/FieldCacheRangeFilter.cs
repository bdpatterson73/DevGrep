...
using NumericField = SmartSearch.Documents.NumericField;
using IndexReader = SmartSearch.Index.IndexReader;
using TermDocs = SmartSearch.Index.TermDocs;
using NumericUtils = SmartSearch.Util.NumericUtils;

namespace SmartSearch.Search
{
    ...
    public static class FieldCacheRangeFilter
	{
        ...
        private class AnonymousClassFieldCacheRangeFilter : FieldCacheRangeFilter<string>
        {
            ...
            {
                private void InitBlock(SmartSearch.Search.StringIndex fcsi, int inclusiveLowerPoint, int inclusiveUpperPoint, FieldCacheRangeFilter<string> enclosingInstance)
                {
                    this.fcsi = fcsi;
                ...
                private SmartSearch.Search.StringIndex fcsi;
                ...
                internal AnonymousClassFieldCacheDocIdSet(SmartSearch.Search.StringIndex fcsi, int inclusiveLowerPoint, int inclusiveUpperPoint, FieldCacheRangeFilter<string> enclosingInstance, SmartSearch.Index.IndexReader Param1, bool Param2)
                    : base(Param1, Param2)
                {
            ...
            internal AnonymousClassFieldCacheRangeFilter(string field, SmartSearch.Search.Parser parser, string lowerVal, string upperVal, bool includeLower, bool includeUpper)
                : base(field, parser, lowerVal, upperVal, includeLower, includeUpper)
            {
            }
            public override DocIdSet GetDocIdSet(IndexReader reader)
            {
                SmartSearch.Search.StringIndex fcsi = SmartSearch.Search.FieldCache_Fields.DEFAULT.GetStringIndex(reader, field);
        ...
        private class AnonymousClassFieldCacheRangeFilter1 : FieldCacheRangeFilter<sbyte?>
        {
            private class AnonymousClassFieldCacheDocIdSet : FieldCacheDocIdSet
            {
                ...
                internal AnonymousClassFieldCacheDocIdSet(sbyte[] values, sbyte inclusiveLowerPoint, sbyte inclusiveUpperPoint, FieldCacheRangeFilter<sbyte?> enclosingInstance, SmartSearch.Index.IndexReader Param1, bool Param2)
                    : base(Param1, Param2)
                {
            ...
            public override DocIdSet GetDocIdSet(IndexReader reader)
            {
                ...
                sbyte[] values = SmartSearch.Search.FieldCache_Fields.DEFAULT.GetBytes(reader, field, (SmartSearch.Search.ByteParser)parser);
        ...
        private class AnonymousClassFieldCacheRangeFilter2 : FieldCacheRangeFilter<short?>
        {
            private class AnonymousClassFieldCacheDocIdSet : FieldCacheDocIdSet
            {
                ...
                internal AnonymousClassFieldCacheDocIdSet(short[] values, short inclusiveLowerPoint, short inclusiveUpperPoint, FieldCacheRangeFilter<short?> enclosingInstance, SmartSearch.Index.IndexReader Param1, bool Param2)
                    : base(Param1, Param2)
                {
                    InitBlock(values, inclusiveLowerPoint, inclusiveUpperPoint, enclosingInstance);
                }
            ...
            public override DocIdSet GetDocIdSet(IndexReader reader)
            {
                ...
                short[] values = SmartSearch.Search.FieldCache_Fields.DEFAULT.GetShorts(reader, field, (SmartSearch.Search.ShortParser)parser);
                // we only request the usage of termDocs, if the range contains 0
                return new AnonymousClassFieldCacheDocIdSet(values, inclusiveLowerPoint, inclusiveUpperPoint, this, reader, (inclusiveLowerPoint <= 0 && inclusiveUpperPoint >= 0));
            }
        }
        ...
        private class AnonymousClassFieldCacheRangeFilter3 : FieldCacheRangeFilter<int?>
        {
            private class AnonymousClassFieldCacheDocIdSet : FieldCacheDocIdSet
            {
                ...
                internal AnonymousClassFieldCacheDocIdSet(int[] values, int inclusiveLowerPoint, int inclusiveUpperPoint, FieldCacheRangeFilter<int?> enclosingInstance, SmartSearch.Index.IndexReader Param1, bool Param2)
                    : base(Param1, Param2)
                {
                    InitBlock(values, inclusiveLowerPoint, inclusiveUpperPoint, enclosingInstance);
                }
            ...
            internal AnonymousClassFieldCacheRangeFilter3(string field, SmartSearch.Search.Parser parser, int? lowerVal, int? upperVal, bool includeLower, bool includeUpper)
                : base(field, parser, lowerVal, upperVal, includeLower, includeUpper)
            {
            }
            public override DocIdSet GetDocIdSet(IndexReader reader)
            {
                ...
                int[] values = SmartSearch.Search.FieldCache_Fields.DEFAULT.GetInts(reader, field, (SmartSearch.Search.IntParser)parser);
                // we only request the usage of termDocs, if the range contains 0
                return new AnonymousClassFieldCacheDocIdSet(values, inclusiveLowerPoint, inclusiveUpperPoint, this, reader, (inclusiveLowerPoint <= 0 && inclusiveUpperPoint >= 0));
            }
        }
        ...
        private class AnonymousClassFieldCacheRangeFilter4 : FieldCacheRangeFilter<long?>
        {
            private class AnonymousClassFieldCacheDocIdSet : FieldCacheDocIdSet
            {
                ...
                internal AnonymousClassFieldCacheDocIdSet(long[] values, long inclusiveLowerPoint, long inclusiveUpperPoint, FieldCacheRangeFilter<long?> enclosingInstance, SmartSearch.Index.IndexReader Param1, bool Param2)
                    : base(Param1, Param2)
                {
                    InitBlock(values, inclusiveLowerPoint, inclusiveUpperPoint, enclosingInstance);
                }
            ...
            internal AnonymousClassFieldCacheRangeFilter4(string field, SmartSearch.Search.Parser parser, long? lowerVal, long? upperVal, bool includeLower, bool includeUpper)
                : base(field, parser, lowerVal, upperVal, includeLower, includeUpper)
            {
            }
            public override DocIdSet GetDocIdSet(IndexReader reader)
            {
                ...
                long[] values = SmartSearch.Search.FieldCache_Fields.DEFAULT.GetLongs(reader, field, (SmartSearch.Search.LongParser)parser);
                // we only request the usage of termDocs, if the range contains 0
        ...
        private class AnonymousClassFieldCacheRangeFilter5 : FieldCacheRangeFilter<float?>
        {
            private class AnonymousClassFieldCacheDocIdSet : FieldCacheDocIdSet
            {
                ...
                internal AnonymousClassFieldCacheDocIdSet(float[] values, float inclusiveLowerPoint, float inclusiveUpperPoint, FieldCacheRangeFilter<float?> enclosingInstance, SmartSearch.Index.IndexReader Param1, bool Param2)
                    : base(Param1, Param2)
                {
                    InitBlock(values, inclusiveLowerPoint, inclusiveUpperPoint, enclosingInstance);
                }
            ...
            internal AnonymousClassFieldCacheRangeFilter5(string field, SmartSearch.Search.Parser parser, float? lowerVal, float? upperVal, bool includeLower, bool includeUpper)
                : base(field, parser, lowerVal, upperVal, includeLower, includeUpper)
            {
            }
            public override DocIdSet GetDocIdSet(IndexReader reader)
            {
                ...
                float[] values = SmartSearch.Search.FieldCache_Fields.DEFAULT.GetFloats(reader, field, (SmartSearch.Search.FloatParser)parser);
                // we only request the usage of termDocs, if the range contains 0
        ...
        private class AnonymousClassFieldCacheRangeFilter6 : FieldCacheRangeFilter<double?>
        {
            private class AnonymousClassFieldCacheDocIdSet : FieldCacheDocIdSet
            {
                ...
                internal AnonymousClassFieldCacheDocIdSet(double[] values, double inclusiveLowerPoint, double inclusiveUpperPoint, FieldCacheRangeFilter<double?> enclosingInstance, SmartSearch.Index.IndexReader Param1, bool Param2)
                    : base(Param1, Param2)
                {
                    InitBlock(values, inclusiveLowerPoint, inclusiveUpperPoint, enclosingInstance);
                }
            ...
            internal AnonymousClassFieldCacheRangeFilter6(string field, SmartSearch.Search.Parser parser, double? lowerVal, double? upperVal, bool includeLower, bool includeUpper)
                : base(field, parser, lowerVal, upperVal, includeLower, includeUpper)
            {
            }
            public override DocIdSet GetDocIdSet(IndexReader reader)
            {
                ...
                double[] values = SmartSearch.Search.FieldCache_Fields.DEFAULT.GetDoubles(reader, field, (SmartSearch.Search.DoubleParser)parser);
                // we only request the usage of termDocs, if the range contains 0
        ...
        /// of the values to <c>null</c>.
        /// </summary>
        public static FieldCacheRangeFilter<sbyte?> NewByteRange(string field, SmartSearch.Search.ByteParser parser, sbyte? lowerVal, sbyte? upperVal, bool includeLower, bool includeUpper)
        {
        ...
        /// of the values to <c>null</c>.
        /// </summary>
        public static FieldCacheRangeFilter<short?> NewShortRange(string field, SmartSearch.Search.ShortParser parser, short? lowerVal, short? upperVal, bool includeLower, bool includeUpper)
        {
        ...
        /// of the values to <c>null</c>.
        /// </summary>
        public static FieldCacheRangeFilter<int?> NewIntRange(string field, SmartSearch.Search.IntParser parser, int? lowerVal, int? upperVal, bool includeLower, bool includeUpper)
        {
        ...
        /// of the values to <c>null</c>.
        /// </summary>
        public static FieldCacheRangeFilter<long?> NewLongRange(string field, SmartSearch.Search.LongParser parser, long? lowerVal, long? upperVal, bool includeLower, bool includeUpper)
        {
        ...
        /// of the values to <c>null</c>.
        /// </summary>
        public static FieldCacheRangeFilter<float?> NewFloatRange(string field, SmartSearch.Search.FloatParser parser, float? lowerVal, float? upperVal, bool includeLower, bool includeUpper)
        {
        ...
        /// of the values to <c>null</c>.
        /// </summary>
        public static FieldCacheRangeFilter<double?> NewDoubleRange(string field, SmartSearch.Search.DoubleParser parser, double? lowerVal, double? upperVal, bool includeLower, bool includeUpper)
        {
	...
	public abstract class FieldCacheRangeFilter<T> : Filter
	{
		...
		internal SmartSearch.Search.Parser parser;
		internal T lowerVal;
		internal T upperVal;
		internal bool includeLower;
		internal bool includeUpper;
		
		protected internal FieldCacheRangeFilter(System.String field, SmartSearch.Search.Parser parser, T lowerVal, T upperVal, bool includeLower, bool includeUpper)
		{
			this.field = field;
			this.parser = parser;
		...
		internal abstract class FieldCacheDocIdSet:DocIdSet
		{
			...
			{
				public AnonymousClassDocIdSetIterator(SmartSearch.Index.TermDocs termDocs, FieldCacheDocIdSet enclosingInstance)
				{
					InitBlock(termDocs, enclosingInstance);
				}
				private void  InitBlock(SmartSearch.Index.TermDocs termDocs, FieldCacheDocIdSet enclosingInstance)
				{
					this.termDocs = termDocs;
					this.enclosingInstance = enclosingInstance;
				}
				private SmartSearch.Index.TermDocs termDocs;
