...
namespace SmartSearch.Search.Spans
{
	...
	public class SpanNotQuery:SpanQuery, System.ICloneable
	{
		...
		{
			public AnonymousClassSpans(SmartSearch.Index.IndexReader reader, SpanNotQuery enclosingInstance)
			{
				InitBlock(reader, enclosingInstance);
			}
			private void  InitBlock(SmartSearch.Index.IndexReader reader, SpanNotQuery enclosingInstance)
			{
				this.reader = reader;
