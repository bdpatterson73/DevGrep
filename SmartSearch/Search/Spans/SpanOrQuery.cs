...
namespace SmartSearch.Search.Spans
{
	...
	public class SpanOrQuery : SpanQuery, System.ICloneable
	{
		...
		{
			public AnonymousClassSpans(SmartSearch.Index.IndexReader reader, SpanOrQuery enclosingInstance)
			{
				InitBlock(reader, enclosingInstance);
			}
			private void  InitBlock(SmartSearch.Index.IndexReader reader, SpanOrQuery enclosingInstance)
			{
				this.reader = reader;
