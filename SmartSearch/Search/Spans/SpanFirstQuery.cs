...
namespace SmartSearch.Search.Spans
{
	...
	public class SpanFirstQuery : SpanQuery, System.ICloneable
	{
		...
		{
			public AnonymousClassSpans(SmartSearch.Index.IndexReader reader, SpanFirstQuery enclosingInstance)
			{
				InitBlock(reader, enclosingInstance);
			}
			private void  InitBlock(SmartSearch.Index.IndexReader reader, SpanFirstQuery enclosingInstance)
			{
				this.reader = reader;
