...
using Document = SmartSearch.Documents.Document;
using FieldSelector = SmartSearch.Documents.FieldSelector;
using SmartSearch.Store;
using Similarity = SmartSearch.Search.Similarity;
...
namespace SmartSearch.Index
{
	...
	/// one of the static <c>open()</c> methods, e.g. <see cref="Open(SmartSearch.Store.Directory, bool)" />
	///.
	...
	public abstract class IndexReader : System.ICloneable, System.IDisposable
	{
		...
		{
			private void  InitBlock(SmartSearch.Store.Directory directory2)
			{
				this.directory2 = directory2;
			}
			private SmartSearch.Store.Directory directory2;
			internal AnonymousClassFindSegmentsFile(SmartSearch.Store.Directory directory2, SmartSearch.Store.Directory Param1):base(Param1)
			{
	    ...
	    /// <see cref="Open(SmartSearch.Store.Directory, bool)" />, or <see cref="Reopen()" /> 
		...
		/// <seealso cref="SmartSearch.Documents.Field.TermVector">
		/// </seealso>
		...
		/// <summary> Get the <see cref="SmartSearch.Documents.Document" /> at the <c>n</c>
		/// <sup>th</sup> position. The <see cref="FieldSelector" /> may be used to determine
		/// what <see cref="SmartSearch.Documents.Field" />s to load and how they should
		/// be loaded. <b>NOTE:</b> If this Reader (more specifically, the underlying
		/// <c>FieldsReader</c>) is closed before the lazy
		/// <see cref="SmartSearch.Documents.Field" /> is loaded an exception may be
		/// thrown. If you want the value of a lazy
		/// <see cref="SmartSearch.Documents.Field" /> to be available after closing you
		...
		/// <see cref="SmartSearch.Documents.Document" /> at the nth position
		/// </returns>
		/// <throws>  CorruptIndexException if the index is corrupt </throws>
		/// <exception cref="System.IO.IOException">If there is a low-level IO error</exception>
		/// <seealso cref="IFieldable">
		/// </seealso>
		/// <seealso cref="SmartSearch.Documents.FieldSelector">
		/// </seealso>
		/// <seealso cref="SmartSearch.Documents.SetBasedFieldSelector">
		/// </seealso>
		/// <seealso cref="SmartSearch.Documents.LoadFirstFieldSelector">
		/// </seealso>
        ...
        /// <summary>Returns an unpositioned <see cref="SmartSearch.Index.TermDocs" /> enumerator.</summary>
        /// <exception cref="System.IO.IOException">If there is a low-level IO error</exception>
        ...
        /// <summary>Returns an unpositioned <see cref="SmartSearch.Index.TermPositions" /> enumerator.</summary>
        /// <exception cref="System.IO.IOException">If there is a low-level IO error</exception>
		...
		/// </summary>
		/// <param name="args">Usage: SmartSearch.Index.IndexReader [-extract] &lt;cfsfile&gt;
		/// </param>
		[STAThread]
		public static void  Main(String[] args)
		{
	    	...
	    	if (filename == null)
			{
				System.Console.Out.WriteLine("Usage: SmartSearch.Index.IndexReader [-extract] <cfsfile>");
				return ;
			}
	    ...
	    /// through <see cref="IndexReader.Open(SmartSearch.Store.Directory,bool)" />. Use the parent reader directly. 
	    /// </summary>
