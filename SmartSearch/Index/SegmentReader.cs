...
namespace SmartSearch.Index
{
	...
	public class SegmentReader : IndexReader
	{
			...
			internal void  DecRef()
			{
				lock (this)
				{
					...
					if (ref_Renamed.DecRef() == 0)
					{
                        ...
                        {
                            SmartSearch.Search.FieldCache_Fields.DEFAULT.Purge(origInstance);
                        }
					}
				}
			}
        ...
        public override System.Collections.Generic.ICollection<string> GetFieldNames(IndexReader.FieldOption fieldOption)
		{
            ...
            System.Collections.Generic.ISet<string> fieldSet = SmartSearch.Support.Compatibility.SetFactory.CreateHashSet<string>();
