...
using FieldSelectorResult = SmartSearch.Documents.FieldSelectorResult;
using FieldOption = SmartSearch.Index.IndexReader.FieldOption;
using MergeAbortedException = SmartSearch.Index.MergePolicy.MergeAbortedException;
...
namespace SmartSearch.Index
{
	...
	public sealed class SegmentMerger
	{
		private class AnonymousClassCheckAbort:CheckAbort
		{
			...
			internal AnonymousClassCheckAbort(SegmentMerger enclosingInstance, SmartSearch.Index.MergePolicy.OneMerge Param1, SmartSearch.Store.Directory Param2):base(Param1, Param2)
			{
		...
		private class AnonymousClassCheckAbort1:CheckAbort
		{
			...
			internal AnonymousClassCheckAbort1(SegmentMerger enclosingInstance, SmartSearch.Index.MergePolicy.OneMerge Param1, SmartSearch.Store.Directory Param2):base(Param1, Param2)
			{
				InitBlock(enclosingInstance);
			}
			public override void  Work(double units)
		...
		{
            ISet<string> fileSet = SmartSearch.Support.Compatibility.SetFactory.CreateHashSet<string>();
