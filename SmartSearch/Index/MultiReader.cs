...
using MultiTermDocs = SmartSearch.Index.DirectoryReader.MultiTermDocs;
using MultiTermEnum = SmartSearch.Index.DirectoryReader.MultiTermEnum;
using MultiTermPositions = SmartSearch.Index.DirectoryReader.MultiTermPositions;
...
namespace SmartSearch.Index
{
    ...
    public class MultiReader:IndexReader, System.ICloneable
    {
        ...
        protected internal override void  DoClose()
        {
            ...
            // not a good idea):
            SmartSearch.Search.FieldCache_Fields.DEFAULT.Purge(this);
        }
