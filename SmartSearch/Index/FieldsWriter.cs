...
using RAMOutputStream = SmartSearch.Store.RAMOutputStream;
...
namespace SmartSearch.Index
{
	...
	sealed class FieldsWriter : IDisposable
	{
        ...
        internal static int FORMAT_SMARTSEARCH_3_0_NO_COMPRESSED_FIELDS = 2;
		
		// NOTE: if you introduce a new format, make it 1 higher
		// than the current one, and always change this if you
		// switch to a new format!
        internal static readonly int FORMAT_CURRENT = FORMAT_SMARTSEARCH_3_0_NO_COMPRESSED_FIELDS;
