...
using DefaultSimilarity = SmartSearch.Search.DefaultSimilarity;
...
namespace SmartSearch.Index
{
    ...
    public class DirectoryReader:IndexReader
    {
        /*new*/ private class AnonymousClassFindSegmentsFile:SegmentInfos.FindSegmentsFile
        {
            ...
            internal AnonymousClassFindSegmentsFile(bool readOnly, SmartSearch.Index.IndexDeletionPolicy deletionPolicy, int termInfosIndexDivisor, SmartSearch.Store.Directory Param1):base(Param1)
            {
        ...
        private class AnonymousClassFindSegmentsFile1:SegmentInfos.FindSegmentsFile
        {
            ...
            internal AnonymousClassFindSegmentsFile1(bool openReadOnly, DirectoryReader enclosingInstance, SmartSearch.Store.Directory Param1):base(Param1)
            {
        ...
        /// <throws>  SmartSearch.Store.LockObtainFailedException </throws>
        ...
        /// <seealso cref="SmartSearch.Index.IndexReader.ListCommits">
        /// </seealso>
