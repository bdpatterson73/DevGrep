...
namespace SmartSearch.Index
{
	...
	public sealed class FieldsReader : ICloneable, IDisposable
	{
		...
		/// <summary> Closes the underlying <see cref="SmartSearch.Store.IndexInput" /> streams, including any ones associated with a
		...
		internal bool CanReadRawDocs()
        {
            ...
            // for <3.0 indexes.
			return format >= FieldsWriter.FORMAT_SMARTSEARCH_3_0_NO_COMPRESSED_FIELDS;
		}
		...
		public /*internal*/ Document Doc(int n, FieldSelector fieldSelector)
		{
			...
			for (int i = 0; i < numFields; i++)
			{
			    ...
			    System.Diagnostics.Debug.Assert(
			        (!compressed || (format < FieldsWriter.FORMAT_SMARTSEARCH_3_0_NO_COMPRESSED_FIELDS)),
