...
namespace SmartSearch.Index
{
	...
	/// <summary> The TermVectorOffsetInfo class holds information pertaining to a Term in a <see cref="SmartSearch.Index.TermPositionVector" />'s
	...
	{
		/// <summary> Convenience declaration when creating a <see cref="SmartSearch.Index.TermPositionVector" /> that stores only position information.</summary>
		[NonSerialized]
