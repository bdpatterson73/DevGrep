...
namespace SmartSearch.Index
{
	...
	public class PositionBasedTermVectorMapper:TermVectorMapper
	{
	    ...
	    /// 
	    /// </summary>
	    /// <value> A map between field names and a Map. The sub-Map key is the position as the integer, the value is &lt;see cref=&quot;SmartSearch.Index.PositionBasedTermVectorMapper.TVPositionInfo&quot; /&gt;. </value>
