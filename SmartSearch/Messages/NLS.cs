...
namespace SmartSearch.Messages
{
	...
	public class NLS
	{
		...
		private static System.Object GetResourceBundleObject(System.String messageKey, System.Globalization.CultureInfo locale)
		{
			...
			for (var it = bundles.Keys.GetEnumerator(); it.MoveNext(); )
			{
                ...
                System.Resources.ResourceManager resourceBundle = System.Resources.ResourceManager.CreateFileBasedResourceManager(clazz.Name, "Messages", null); //{{SmartSearch-2.9.1}} Can we make resourceDir "Messages" more general?
