...
using CachingTokenFilter = SmartSearch.Analysis.CachingTokenFilter;
using TokenStream = SmartSearch.Analysis.TokenStream;
using DateField = SmartSearch.Documents.DateField;
using DateTools = SmartSearch.Documents.DateTools;
...
using FuzzyQuery = SmartSearch.Search.FuzzyQuery;
using MatchAllDocsQuery = SmartSearch.Search.MatchAllDocsQuery;
using MultiPhraseQuery = SmartSearch.Search.MultiPhraseQuery;
using MultiTermQuery = SmartSearch.Search.MultiTermQuery;
...
using WildcardQuery = SmartSearch.Search.WildcardQuery;
...
namespace SmartSearch.QueryParsers
{
    ...
    /// <see cref="SmartSearch.Documents.DateTools.Resolution" /> has to be set.
    /// <p/>
    /// <p/>
    ...
    public class QueryParser : QueryParserConstants
    {
            ...
            : this(new FastCharStream(new StringReader("")))
        {
            analyzer = a;
            field = f;
            if (matchVersion.OnOrAfter(Version.SmartSearch_29))
            {
            ...
            // LUCENENET-423 - DateRange differences with Java and .NET
            if (matchVersion.OnOrAfter(Version.SmartSearch_30))
            {
                _useJavaStyleDateRangeParsing = true;
            }
        }

        /// <summary>Parses a query string, returning a {@link SmartSearch.Search.Query}.</summary>
        ...
        /// <summary> Command line tool to test QueryParser, using {@link SmartSearch.Analysis.SimpleAnalyzer}.
        /// Usage:<br/>
        /// <c>java SmartSearch.QueryParsers.QueryParser &lt;input&gt;</c>
        /// </summary>
        [STAThread]
        public static void Main(String[] args)
        {
            ...
            QueryParser qp = new QueryParser(Version.SmartSearch_CURRENT, "field", new SimpleAnalyzer());
