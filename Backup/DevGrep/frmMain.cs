...
namespace DevGrep
{
    ...
    public class frmMain : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.chMatches = new System.Windows.Forms.ColumnHeader();
            ...
            this.toolBar1.Size = new System.Drawing.Size(568, 50);
            ...
            this.panel1.Size = new System.Drawing.Size(568, 319);
            ...
            this.rtbResults.Size = new System.Drawing.Size(568, 60);
            ...
            this.splitter1.Size = new System.Drawing.Size(568, 3);
            ...
            this.lvFiles.Size = new System.Drawing.Size(568, 224);
            ...
            this.lblInfo.Size = new System.Drawing.Size(568, 16);
...
//            }
        ...
        {
            MessageBox.Show("by Brian D. Patterson (c) 2005-2008");
        }
        #endregion
        ...
        private void mnuSave_Click(object sender, EventArgs e)
        {
            ...
            {
                dsSavedFile dsf = new dsSavedFile();
                DataRow dr = dsf.Tables[0].NewRow();
                dr["SearchString"] = this._SearchText;
                dr["SearchPath"] = this._SearchPath;
                dr["IncludeSub"] = this._Subdirectories;
                dr["FileExt"] = this._SearchExtensions;
                dr["CaseSensative"] = this._MatchCase;
        ...
        {
            dsSavedFile savedFile = new dsSavedFile();
            ...
            {
                this._SearchExtensions = dFileExt;
                this._SearchPath = dSearchPath;
                this._SearchText = dSearchString;
                this._Subdirectories = dIncludeSub.ToUpper() == "TRUE" ? true : false;
                InitSearch();
            }
        }
        #endregion
        ...
        private void printDocument1_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("DevGrep (c) 2005-2008 Brian D. Patterson", fSmall, drawBrushB, e.MarginBounds.X, e.MarginBounds.Bottom + 20);
