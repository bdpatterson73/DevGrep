    ...
    internal static class DynamicUtils
    {
      ...
      public const string CSharpAssemblyName = "Microsoft.CSharp, Version=5.0.5.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35";
            ...
            private static object CreateSharpArgumentInfoArray(params int[] values)
            {
                ...
                {
                    MethodInfo createArgumentInfoMethod = csharpArgumentInfoType.GetMethod("Create",
                                                                                           new[]
                                                                                               {
            ...
            private static void CreateMemberCalls()
            {
                ...
                MethodInfo getMemberMethod = binderType.GetMethod("GetMember",
                                                                  new[]
                                                                      {
                                                                          csharpBinderFlagsType, typeof (string),
                                                                          typeof (Type),
                ...
                MethodInfo setMemberMethod = binderType.GetMethod("SetMember",
                                                                  new[]
                                                                      {
                                                                          csharpBinderFlagsType, typeof (string),
                                                                          typeof (Type),
