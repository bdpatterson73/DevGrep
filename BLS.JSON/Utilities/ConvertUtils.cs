    ...
    internal static class ConvertUtils
    {
        ...
        private static readonly List<TypeInformation> PrimitiveTypeCodes = new List<TypeInformation>
            {
                ...
                new TypeInformation {Type = typeof (object), TypeCode = PrimitiveTypeCode.Empty},
                // no 17 in TypeCode for some reason
      ...
      return TimeSpan.Parse((string)input);
        ...
        internal static BigInteger ToBigInteger(object value)
        {
            ...
            throw new InvalidCastException("Cannot convert {0} to BigInteger.".FormatWith(CultureInfo.InvariantCulture,
                                                                                          value.GetType()));
        }
        ...
        public static object FromBigInteger(BigInteger i, Type targetType)
        {
            ...
            catch (Exception ex)
            {
                throw new InvalidOperationException(
                    "Can not convert from BigInteger to {0}.".FormatWith(CultureInfo.InvariantCulture, targetType), ex);
            }
        }
#endif
