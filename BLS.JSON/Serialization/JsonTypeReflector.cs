...
namespace BLS.JSON.Serialization
{
    ...
    internal static class JsonTypeReflector
    {
        ...
        private static readonly ThreadSafeStore<object, Type> JsonConverterTypeCache =
            new ThreadSafeStore<object, Type>(GetJsonConverterTypeFromAttribute);
      ...
      return null;
        ...
        private static Type GetAssociateMetadataTypeFromAttribute(Type type)
        {
            ...
            IMetadataTypeAttribute metadataTypeAttribute = (DynamicCodeGeneration)
                                                               ? DynamicWrapper.CreateWrapper<IMetadataTypeAttribute>(
                                                                   attribute)
