    ...
    private BindingFlags DefaultMembersSearchFlags = BindingFlags.Instance | BindingFlags.Public;
      ...
      ignoreSerializableAttribute = true;
            ...
            if (memberSerialization != MemberSerialization.Fields)
            {
                ...
                List<MemberInfo> defaultMembers =
                    ReflectionUtils.GetFieldsAndProperties(objectType, DefaultMembersSearchFlags)
                                   .Where(m => !ReflectionUtils.IsIndexedProperty(m)).ToList();
                        ...
                        else
                        {
                            ...
                            if (JsonTypeReflector.GetAttribute<JsonPropertyAttribute>(member) != null)
                                serializableMembers.Add(member);
                                     ...
                                     JsonTypeReflector.GetAttribute<DataMemberAttribute>(member) != null)
                                serializableMembers.Add(member);
#endif
      ...
      ignoreSerializableAttribute = true;
            ...
            if (overrideConstructor != null)
            {
                ...
                contract.ConstructorParameters.AddRange(CreateConstructorParameters(overrideConstructor,
                                                                                    contract.Properties));
            }
                                                                          ...
                                                                          JsonPropertyCollection memberProperties)
        {
            ...
            foreach (ParameterInfo parameterInfo in constructorParameters)
            {
                ...
                JsonProperty matchingMemberProperty = (parameterInfo.Name != null)
                                                          ? memberProperties.GetClosestMatchProperty(parameterInfo.Name)
                                                          : null;
        ...
        /// <param name="objectType">Type of the object.</param>
        /// <returns>
        ///     The contract's default <see cref="JsonConverter" />.
        /// </returns>
        ...
        private void InitializeContract(JsonContract contract)
        {
            JsonContainerAttribute containerAttribute =
                JsonTypeReflector.GetJsonContainerAttribute(contract.NonNullableUnderlyingType);
            ...
            foreach (Type baseType in GetClassHierarchyForType(type))
            {
                ...
                foreach (
                    MethodInfo method in
                        baseType.GetMethods(BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance |
        ...
        protected virtual JsonISerializableContract CreateISerializableContract(Type objectType)
        {
            ...
            {
                MethodCall<object, object> methodCall =
                    JsonTypeReflector.ReflectionDelegateFactory.CreateMethodCall<object>(constructorInfo);
      ...
      valueProvider = new ReflectionValueProvider(member);
        ...
        private void SetPropertySettingsFromAttributes(JsonProperty property, object attributeProvider, string name,
                                                       Type declaringType, MemberSerialization memberSerialization,
