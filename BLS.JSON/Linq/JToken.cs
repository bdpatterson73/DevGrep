...
namespace BLS.JSON.Linq
{
...
#endif
    {
        ...
        private static readonly JTokenType[] BigIntegerTypes = new[]
            {
                JTokenType.Integer, JTokenType.Float, JTokenType.String, JTokenType.Comment, JTokenType.Raw,
                JTokenType.Boolean, JTokenType.Bytes
            };
        ...
        private static readonly JTokenType[] StringTypes = new[]
            {
                ...
                JTokenType.Raw, JTokenType.Boolean, JTokenType.Bytes, JTokenType.Guid, JTokenType.TimeSpan,
                JTokenType.Uri
            };
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="System.Boolean" />.
        /// </summary>
        /// <param name="value">The value.</param>
...
#if !NET20
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="System.DateTimeOffset" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="Nullable{Boolean}" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static explicit operator bool?(JToken value)
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="System.Int64" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="Nullable{DateTime}" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
...
#if !NET20
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="Nullable{DateTimeOffset}" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static explicit operator DateTimeOffset?(JToken value)
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="Nullable{Decimal}" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="Nullable{Double}" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="Nullable{Char}" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static explicit operator char?(JToken value)
        {
            ...
            if (v == null || !ValidateToken(v, CharTypes, true))
                throw new ArgumentException("Can not convert {0} to Char.".FormatWith(CultureInfo.InvariantCulture,
                                                                                      GetType(value)));
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="System.Int32" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="System.Int16" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="System.UInt16" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        [CLSCompliant(false)]
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="System.Char" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        [CLSCompliant(false)]
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="System.Byte" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static explicit operator byte(JToken value)
        {
            JValue v = EnsureValue(value);
            if (v == null || !ValidateToken(v, NumberTypes, false))
                throw new ArgumentException("Can not convert {0} to Byte.".FormatWith(CultureInfo.InvariantCulture,
                                                                                      GetType(value)));
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="Nullable{Int32}" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static explicit operator int?(JToken value)
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="Nullable{Int16}" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static explicit operator short?(JToken value)
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="Nullable{UInt16}" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        [CLSCompliant(false)]
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="Nullable{Byte}" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static explicit operator byte?(JToken value)
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="System.DateTime" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static explicit operator DateTime(JToken value)
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="Nullable{Int64}" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static explicit operator long?(JToken value)
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="Nullable{Single}" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="System.Decimal" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static explicit operator decimal(JToken value)
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="Nullable{UInt32}" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        [CLSCompliant(false)]
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="Nullable{UInt64}" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        [CLSCompliant(false)]
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="System.Double" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static explicit operator double(JToken value)
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="System.Single" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static explicit operator float(JToken value)
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="System.String" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="System.UInt32" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        [CLSCompliant(false)]
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="System.UInt64" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        [CLSCompliant(false)]
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="T:System.Byte[]" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static explicit operator byte[](JToken value)
        {
            ...
            throw new ArgumentException("Can not convert {0} to byte array.".FormatWith(CultureInfo.InvariantCulture,
                                                                                        GetType(value)));
        }

        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="System.Guid" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static explicit operator Guid(JToken value)
        {
            ...
            if (v == null || !ValidateToken(v, GuidTypes, false))
                throw new ArgumentException("Can not convert {0} to Guid.".FormatWith(CultureInfo.InvariantCulture,
                                                                                      GetType(value)));

            if (v.Value is byte[])
                return new Guid((byte[]) v.Value);

            return (v.Value is Guid)
                       ? (Guid) v.Value
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="System.TimeSpan" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static explicit operator TimeSpan(JToken value)
        {
            ...
            if (v == null || !ValidateToken(v, TimeSpanTypes, false))
                throw new ArgumentException("Can not convert {0} to TimeSpan.".FormatWith(CultureInfo.InvariantCulture,
                                                                                          GetType(value)));

            return (v.Value is TimeSpan)
                       ? (TimeSpan) v.Value
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="BLS.JSON.Linq.JToken" /> to <see cref="System.Uri" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static explicit operator Uri(JToken value)
        {
            ...
            if (v == null || !ValidateToken(v, UriTypes, true))
                throw new ArgumentException("Can not convert {0} to Uri.".FormatWith(CultureInfo.InvariantCulture,
                                                                                     GetType(value)));
        ...
        private static BigInteger ToBigInteger(JToken value)
        {
            ...
            if (v == null || !ValidateToken(v, BigIntegerTypes, false))
                throw new ArgumentException("Can not convert {0} to BigInteger.".FormatWith(
                    CultureInfo.InvariantCulture, GetType(value)));
        ...
        /// <summary>
        ///     Performs an implicit conversion from <see cref="T:System.Byte[]" /> to <see cref="BLS.JSON.Linq.JToken" />.
        /// </summary>
        /// <param name="value">
        ///     The value to create a <see cref="JValue" /> from.
        /// </param>
        ...
        /// <summary>
        ///     Performs an implicit conversion from <see cref="T:System.Uri" /> to <see cref="BLS.JSON.Linq.JToken" />.
        /// </summary>
        /// <param name="value">
        ///     The value to create a <see cref="JValue" /> from.
        /// </param>
        ...
        /// <summary>
        ///     Performs an implicit conversion from <see cref="T:System.TimeSpan" /> to <see cref="BLS.JSON.Linq.JToken" />.
        /// </summary>
        /// <param name="value">
        ///     The value to create a <see cref="JValue" /> from.
        /// </param>
        ...
        /// <summary>
        ///     Performs an implicit conversion from <see cref="Nullable{TimeSpan}" /> to <see cref="BLS.JSON.Linq.JToken" />.
        /// </summary>
        /// <param name="value">
        ///     The value to create a <see cref="JValue" /> from.
        /// </param>
        ...
        /// <summary>
        ///     Performs an implicit conversion from <see cref="T:System.Guid" /> to <see cref="BLS.JSON.Linq.JToken" />.
        /// </summary>
        /// <param name="value">
        ///     The value to create a <see cref="JValue" /> from.
        /// </param>
        ...
        /// <summary>
        ///     Performs an implicit conversion from <see cref="Nullable{Guid}" /> to <see cref="BLS.JSON.Linq.JToken" />.
        /// </summary>
        /// <param name="value">
        ///     The value to create a <see cref="JValue" /> from.
        /// </param>
