...
namespace BLS.JSON.Linq
{
    ...
    /// </summary>
    /// <example>
    ///     <code lang="cs" source="..\Src\BLS.JSON.Tests\Documentation\LinqToJsonTests.cs" region="LinqToJsonCreateParseArray"
    ///         title="Parsing a JSON Array from Text" />
    /// </example>
    public class JArray : JContainer, IList<JToken>
    {
        ...
        /// <summary>
        ///     Gets or sets the <see cref="BLS.JSON.Linq.JToken" /> at the specified index.
        /// </summary>
        /// <value></value>
