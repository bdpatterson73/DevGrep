...
namespace BLS.JSON.Linq
{
    ...
    /// </summary>
    /// <example>
    ///     <code lang="cs" source="..\Src\BLS.JSON.Tests\Documentation\LinqToJsonTests.cs" region="LinqToJsonCreateParse"
...
#endif
    {
        ...
        /// <summary>
        ///     Gets or sets the <see cref="BLS.JSON.Linq.JToken" /> with the specified property name.
        /// </summary>
        /// <value></value>
        ...
        /// <summary>
        ///     Gets the <see cref="BLS.JSON.Linq.JToken" /> with the specified property name.
        /// </summary>
        /// <param name="propertyName">Name of the property.</param>
        /// <returns>
        ///     The <see cref="BLS.JSON.Linq.JToken" /> with the specified property name.
        /// </returns>
        ...
        /// <summary>
        ///     Tries to get the <see cref="BLS.JSON.Linq.JToken" /> with the specified property name.
        ///     The exact property name will be searched for first and if no matching property is found then
        ///     the <see cref="StringComparison" /> will be used to match a property.
        /// </summary>
        /// <param name="propertyName">Name of the property.</param>
