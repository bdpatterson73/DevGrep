...
namespace BLS.JSON
{
    ...
    public class JsonTextWriter : JsonWriter
    {
        ...
        {
            EnsureWriteBuffer();
            JavaScriptUtils.WriteEscapedJavaScriptString(_writer, value, _quoteChar, true, _charEscapeFlags,
                                                         StringEscapeHandling, ref _writeBuffer);
        }
        ...
        /// <summary>
        ///     Writes a <see cref="Nullable{T}" /> value.
        /// </summary>
        /// <param name="value">
        ...
        public override void WriteValue(DateTimeOffset value)
        {
            ...
            if (string.IsNullOrEmpty(DateFormatString))
            {
                ...
                int pos = 0;
                _writeBuffer[pos++] = _quoteChar;
                pos = DateTimeUtils.WriteDateTimeString(_writeBuffer, pos,
                                                        (DateFormatHandling == DateFormatHandling.IsoDateFormat)
                                                            ? value.DateTime
                                                            : value.UtcDateTime, value.Offset, DateTimeKind.Local,
                                                        DateFormatHandling);
                _writeBuffer[pos++] = _quoteChar;
