    ...
    public class JsonTextReader : JsonReader, IJsonLineInfo
    {
        ...
        private void ParseNumber()
        {
            ...
            if (_readType == ReadType.ReadAsInt32)
            {
                ...
                {
                    numberValue = ConvertUtils.Int32Parse(_stringReference.Chars, _stringReference.StartIndex,
                                                          _stringReference.Length);
                }
            ...
            else
            {
                ...
                {
                    long value;
                    ParseResult parseResult = ConvertUtils.Int64TryParse(_stringReference.Chars,
                                                                         _stringReference.StartIndex,
                                                                         _stringReference.Length, out value);
