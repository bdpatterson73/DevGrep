...
namespace DevGrep.Classes.DataTypes.ExtensionMethods
{
    ...
    internal static class IEnumerableExtensions
    {
        ...
        public static IEnumerable<T> ThrowIfTrueForAll<T, E>(this IEnumerable<T> Items, E Exception,
                                                             params Predicate<T>[] Predicates) where E : Exception
        {
        ...
        /// <returns>the original list</returns>
        public static IEnumerable<T> ThrowIfFalseForAll<T, E>(this IEnumerable<T> Items, E Exception,
                                                              params Predicate<T>[] Predicates) where E : Exception
        {
            Predicates.ThrowIfNull("Predicates");
            Exception.ThrowIfNull("Exception");
        ...
        /// <returns>the original IEnumerable</returns>
        public static IEnumerable<T> ThrowIfTrueForAny<T, E>(this IEnumerable<T> Items, E Exception,
                                                             params Predicate<T>[] Predicates) where E : Exception
        {
            Predicates.ThrowIfNull("Predicates");
            Exception.ThrowIfNull("Exception");
        ...
        /// <param name="Exception">Exception to throw if predicates are false</param>
        /// <returns>the original list</returns>
        public static IEnumerable<T> ThrowIfFalseForAny<T, E>(this IEnumerable<T> Items, E Exception,
                                                              params Predicate<T>[] Predicates) where E : Exception
        {
            Predicates.ThrowIfNull("Predicates");
            Exception.ThrowIfNull("Exception");
        ...
        public static Target[] ToArray<Source, Target>(this IEnumerable<Source> List,
                                                       Func<Source, Target> ConvertingFunction)
        {
            List.ThrowIfNull("List");
