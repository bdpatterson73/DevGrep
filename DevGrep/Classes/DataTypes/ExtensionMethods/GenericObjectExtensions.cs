...
namespace DevGrep.Classes.DataTypes.ExtensionMethods
{
    ...
    internal static class GenericObjectExtensions
    {
        ...
        public static R Chain<T, R>(this T Object, Func<T, R> Function, R DefaultReturnValue = default(R),
                                    T DefaultObjectValue = default(T))
        {
            Object = Object.NullCheck(DefaultObjectValue);
        ...
        public static T Execute<T>(this Func<T> Function, int Attempts = 3, int RetryDelay = 0,
