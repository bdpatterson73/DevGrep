...
namespace DevGrep.Controls.TreeMaps.TreeMapGen.XmlLib
{
    internal class XmlUtil
    {
        ...
        public static bool GetInt32Attribute(XmlNode oNode, string sName, bool bRequired, out int iValue)
        {
            ...
            string text;
            bool result;
            if (!GetAttribute(oNode, sName, bRequired, out text))
            {
                iValue = -2147483648;
                result = false;
            }
            else
            {
                ...
                catch (Exception ex)
                {
                    throw new InvalidOperationException(
                        "XmlUtil.GetInt32Attribute: Can't convert " + text + " from String to Int32.", ex);
                }
                result = true;
            }
            return result;
        ...
        public static bool GetInt64Attribute(XmlNode oNode, string sName, bool bRequired, out long i64Value)
        {
            ...
            else
            {
                ...
                {
                    throw new InvalidOperationException(
                        "XmlUtil.GetInt64Attribute: Can't convert " + text + " from String to Int64.", ex);
                }
                result = true;
            }
            return result;
        ...
        public static bool GetSingleAttribute(XmlNode oNode, string sName, bool bRequired, out float fValue)
        {
            ...
            else
            {
                ...
                {
                    throw new InvalidOperationException(
                        "XmlUtil.GetSingleAttribute: Can't convert " + text + " from String to Single.", ex);
                }
                result = true;
            }
            return result;
        ...
        public static bool GetDateTimeAttribute(XmlNode oNode, string sName, bool bRequired, out DateTime oValue)
        {
            ...
            else
            {
                ...
                {
                    throw new InvalidOperationException(
                        "XmlUtil.GetDateTimeAttribute: Can't convert " + text + " from String to DateTime.", ex);
                }
                result = true;
            }
            return result;
        ...
        public static void SetAttributes(XmlNode oNode, params string[] asNameValuePairs)
        {
            ...
            if (num%2 != 0)
            {
                throw new ArgumentException(
                    "XmlUtil.SetAttributes: asNameValuePairs must contain an even number of strings.");
            }
            var xmlElement = (XmlElement) oNode;
