...
namespace DevGrep.Controls.TreeMaps.TreeMapGen.Treemap
{
    ...
    {
        Nodes Nodes { get; }
        string NodesXml { get; set; }
        LayoutAlgorithm LayoutAlgorithm { get; set; }
        int PaddingPx { get; set; }
        int PaddingDecrementPerLevelPx { get; set; }
        int PenWidthPx { get; set; }
        int PenWidthDecrementPerLevelPx { get; set; }
        Color BackColor { get; set; }
        Color BorderColor { get; set; }
        NodeColorAlgorithm NodeColorAlgorithm { get; set; }
        Color MinColor { get; set; }
        Color MaxColor { get; set; }
        float MinColorMetric { get; set; }
        float MaxColorMetric { get; set; }
        int DiscreteNegativeColors { get; set; }
        int DiscretePositiveColors { get; set; }
        string FontFamily { get; set; }
        Color FontSolidColor { get; set; }
        Color SelectedFontColor { get; set; }
        Color SelectedBackColor { get; set; }
        NodeLevelsWithText NodeLevelsWithText { get; set; }
        TextLocation TextLocation { get; set; }
        EmptySpaceLocation EmptySpaceLocation { get; set; }
