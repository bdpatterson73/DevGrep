...
namespace System.Windows.Forms
{
   ...
   public class RibbonButton : RibbonItem, IContainsRibbonComponents
   {
      ...
      [Description("Contains the currently selected item in the dropdown.")]
      ...
      /// </summary>
      [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
      [Description("Contains the currently selected value in the dropdown.")]
      ...
      /// </summary>
      [DefaultValue(true)]
      [Description("Determines if the icons bar should be drawn.")]
      ...
      [Description("Define the default style  of this control.")]
      ...
      [Description("Gets or sets the minimum size for this Item.  Only applies when in Large Size Mode.")]
      ...
      /// </summary>
      [DefaultValue(typeof(Size), "0, 0")]
      [Description("Gets or sets the maximum size for this Item.  Only applies when in Large Size Mode.")]
