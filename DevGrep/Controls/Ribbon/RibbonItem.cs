...
namespace System.Windows.Forms
{
	...
	public abstract class RibbonItem : Component, IRibbonElement, IRibbonToolTip
	{
      ...
      [DefaultValue(false)]
      [Category("Flash")]
      [Description("Indicates if the image should be flashing.")]
      ...
      [DefaultValue(1000)]
      [Category("Flash")]
      [Description("Defines the interval at which an image should flash - in milliseconds.")]
      ...
      [DefaultValue(null)]
      [Category("Flash")]
      [Description("Set an image that will alternate with the current objects image.")]
      ...
      [DefaultValue(false)]
      [Browsable(false)]
      [Description("When set, will flash an image.")]
      public bool ShowFlashImage
      {
        ...
        [DefaultValue(null)]
		[Localizable(true)]
        [Description("Set the text that is to be displayed on this item.")]
		...
		/// </summary>
		[DefaultValue(null)]
        [Description("Set the image to be displayed on this item.")]
		...
		/// </summary>
		[DefaultValue(true)]
        [Description("Determines if this object is visible at runtime.")]
		...
		/// </summary>
		[DefaultValue(true)]
        [Description("Indicates if this item is currently enabled.")]
		...
		/// </summary>
		[DefaultValue("")]
        [Description("Set the tool tip title.")]
		...
		[DefaultValue(null)]
		[Localizable(true)]
        [Description("Set the tool tip text to display.")]
		...
		[DefaultValue(null)]
		[Localizable(true)]
        [Description("Set the tool tip image to display.")]
      ...
      public object Tag
		...
		/// </summary>
        [DefaultValue(null)]
        [Description("Gets or sets the key combination that activates this element when the Alt key is pressed")]
        ...
        [Description("Set the maximum size mode of the element")]
		...
		/// </summary>
		[DefaultValue(RibbonElementSizeMode.None)]
        [Description("Set the minimum size mode of the element")]
        ...
        [Description("Sets the alignment of the label text if it exists")]
