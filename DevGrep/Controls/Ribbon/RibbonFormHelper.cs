               ...
               //         Form.Height - Margins.Vertical - 0));
                g.FillRectangle(b,
                     Rectangle.FromLTRB(
                         ...
                         Form.Width  - 0,
                         Form.Height  - 0));
               //Console.WriteLine(Margins.Left + ":" + Margins.Top + ":" + (Form.Width - Margins.Horizontal - 0).ToString() + ":" + (Form.Height - Margins.Vertical - 0).ToString() + "?" + Margins.Horizontal + "?" + Margins.Vertical);
            }
