...
using BLS.TextEditor.Src.Document.HighlightingStrategy.SyntaxModes;
	...
	public static class HighlightingDefinitionParser
	{
		...
		public static DefaultHighlightingStrategy Parse(DefaultHighlightingStrategy highlighter, SyntaxMode syntaxMode, XmlReader xmlReader)
		{
			...
			try {
				...
				Stream shemaStream = typeof(HighlightingDefinitionParser).Assembly.GetManifestResourceStream("BLS.TextEditor.Resources.Mode.xsd");
