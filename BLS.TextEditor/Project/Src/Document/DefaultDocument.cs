...
using BLS.TextEditor.Src.Document.FoldingStrategy;
using BLS.TextEditor.Src.Document.FormattingStrategy;
using BLS.TextEditor.Src.Document.HighlightingStrategy;
using BLS.TextEditor.Src.Document.LineManager;
using BLS.TextEditor.Src.Document.TextBufferStrategy;
using BLS.TextEditor.Src.Gui;
using BLS.TextEditor.Src.Undo;
