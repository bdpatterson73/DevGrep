...
namespace BLS.TextEditor.Src.Document.BookmarkManager
{
	...
	public class Bookmark
	{
		...
		public virtual bool Click(System.Windows.Forms.Control parent, System.Windows.Forms.MouseEventArgs e)
		{
			if (e.Button == System.Windows.Forms.MouseButtons.Left && CanToggle) {
				document.BookmarkManager.RemoveMark(this);
				return true;
			}
			return false;
